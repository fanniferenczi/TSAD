...
ax1.set_title('F1 Score Distribution per Dataset (Point-Adjust Evaluation)', fontsize=13)
ax1.set_ylim(55, 102)
...
ax2.set_title('F1 Score Distribution per Model (Point-Adjust Evaluation)', fontsize=13)
ax2.set_ylim(55, 102)
