...
\begin{figure}[p]
    ...
    three panels show: the input signal with ground truth anomaly windows 
    (orange); the input signal versus the model reconstruction (dashed green); 
...
\begin{figure}[ht]
    ...
    The three panels show: the input signal with ground truth anomaly windows 
    (orange); the input signal versus the reconstruction (dashed green); and 
