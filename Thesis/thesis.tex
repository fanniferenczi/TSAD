...
Chapter~\ref{ch:selected_models} describes the five models evaluated in this thesis, c
overing their architectural design and anomaly detection approach. Chapter~\ref{ch:experiments} 
...
architectural diversity, and relevance to IoT edge deployment. Table~\ref{tab:model_summary} 
...
\begin{tabular}{lllll}
\toprule
\textbf{Model} & \textbf{Architecture} & \textbf{Approach} & \textbf{Learning Scheme} \\
\midrule
TimesNet \citep{timesnet2023} & CNN & Reconstruction & Unsupervised  \\
ModernTCN \citep{moderntcn2024} & CNN & Reconstruction & Unsupervised  \\
TranAD \citep{tranad2022} & Transformer & Reconstruction & Unsupervised  \\
Anomaly Tran. \citep{anomalytransformer2022} & Transformer & Reconstruction & Unsupervised  \\
GTA \citep{gta2022} & Transformer + GNN & Forecasting & Unsupervised  \\
\bottomrule
\end{tabular}
\end{table}
...
shift in latency and throughput, with the latenccy increase and throguhput reduction factors 
annotated directly
