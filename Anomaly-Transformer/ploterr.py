...
OUTPUT_FILE    = "smap_anomalytransformer_signal_recon.png"
...
# Panel 1: signal vs reconstruction + AnomalyTransformer detections
...
# Panel 2: reconstruction error + threshold + AnomalyTransformer detections
