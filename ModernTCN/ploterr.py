...
# Panel 1: signal vs reconstruction + ModernTCN detections
...
ax2.set_title("Signal vs ModernTCN reconstruction", fontsize=12, pad=4)
ax2.tick_params(labelbottom=False, labelsize=8)
ax2.spines[["top", "right"]].set_visible(False)
ax2.legend(loc="upper right", bbox_to_anchor=(1.10, 0.96), fontsize=10, framealpha=0.8)

# Panel 2: reconstruction error + threshold + ModernTCN detections
...
handles = [
    ...
    mpatches.Patch(color=WONG["sky_blue"],   alpha=0.5, label="ModernTCN reported anomaly"),
]
