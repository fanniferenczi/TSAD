"""
TimesNet SMAP — Segment-Level Detection Report
===============================================
Reads SMAP_test_label.npy and predictions_raw.npy directly.
No CSV, no channel names, no offsets.

Output: smap_timesnet_segments.xlsx
...
OUTPUT_FILE = "smap_timesnet_segments.xlsx"
